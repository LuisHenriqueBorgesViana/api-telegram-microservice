...
@Data
public class TelegramGetMethod {
	 ...
	 */
	public TelegramResponseObjectUser getMe(String urlApi, String tokenApi) throws IOException {
		...
		return new Gson().fromJson(responseOkHttp.body().string(), TelegramResponseObjectUser.class);
	}
}
